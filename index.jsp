...
<html lang="en">
  ...
  <body>
    ...
    <img alt="image" class="img-fluid mx-auto" style="max-width: 400px;"  src="img/noteindex.png"> 
    <h1 class="text-primary text-uppercase text-center mt-3">start taking your notes
    </h1>  
    <br>
